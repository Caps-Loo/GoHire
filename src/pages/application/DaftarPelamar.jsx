            ...
            <tbody>
              {applicants.length === 0 ? (
                ...
                applicants.map((applicant, index) => (
                  <tr key={applicant.id} className={index % 2 === 0 ? "bg-gray-50" : "bg-white"}>
                    <td className="border px-4 py-2 text-center">{index + 1}</td>
                    <td className="border px-4 py-2 text-center">{applicant.name || "Unknown"}</td>
                    ...
                    <td className="border px-4 py-2 text-center">
                      <button
                        ...
                        onClick={() => navigate(`/detail-pelamar/${applicant.id}`)}
                      >
                        Lihat Detail
                      </button>
                      <button
